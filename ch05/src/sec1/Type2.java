...
public class Type2 {
	...
	public static void main(String[] args) {
		...
		int [] arr2 = {10,20,30};
		int [] arr3;
		/*int [] arr3 = null; 이거 안되는거임*/ //reference type은 null값을 허용하나 pointer(히프영역의 주소)가 null이 되어 참조할 수 없는 예외가 발생함
		...
		System.out.println(arr1!=arr2);
		//참조형은 간접비교를 해야 하므로 직접비교하게 되면,포인터주소를 비교하게 되므로 서로 다르게  인식된다.
	}
}
